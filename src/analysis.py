...
def _digest_prompt(news_text):
    return f"""Ты — международный аналитик. Составь дневной дайджест мировых событий с фокусом на политику, геополитику, технологии и крупные сделки M&A.
...
{{
  ...
  "action": "на что обратить внимание в ближайшие дни",
  "risk": "главный геополитический или экономический риск прямо сейчас",
  "reasoning": "подробный обзор важнейших событий (5-7 предложений) — политика, саммиты, санкции, технологии, M&A сделки, их взаимосвязь и значение",
  "education": "образовательный блок (3-5 предложений) — объясни один важный концепт из сегодняшних событий. Например: как работают санкции, что такое M&A синергия, почему решение ФРС влияет на весь рынок, как работает G7",
  "top_events": ["краткое описание события 1", "краткое описание события 2", "краткое описание события 3"]
}}"""
